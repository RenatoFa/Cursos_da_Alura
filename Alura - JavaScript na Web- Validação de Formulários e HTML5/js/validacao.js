...
const mensagensDeErro = {
  ...
  senha: {
    ...
    patternMismatch: 'A senha deve conter entre 6 e 12 caracteres,deve conter pelo menos uma\
      letra maiúscula, um número e não deve conter símbolos'
  },
  dataNascimento: {
...
const validadores = {
  dataNascimento: input => validaDataNascimeento(input),
...
const validaDataNascimeento = (input) => {
  const dataRecebida = new Date(input.value)
  let mensagem = ''

  if (!maiorQue18(dataRecebida)) {
    mensagem = 'Voçê deve ser maior que 18 anos para se cadastrar.'
  }
